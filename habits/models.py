...
class Habit(models.Model):
    ...
    reward = models.CharField(max_length=150, verbose_name="награда за выполнение",
                              help_text="опишите награду за выполнение привычки", **NULLABLE)
    ...
    is_published = models.BooleanField(verbose_name="признак публикации", help_text="опубликовать привычку",
                                       default=True)
